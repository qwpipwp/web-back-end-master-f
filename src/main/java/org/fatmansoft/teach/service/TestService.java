...
public class TestService {
    ...
    public void testQuery(){
        List list = scoreRepository.findScoreListByStudentId(1);
        list = scoreRepository.findScoreListByCourseNumName("1");
        list = scoreRepository.findCourseList(1);
        list = familyMemberRepository.findFamilyMemberListByNumName("1");
        list =familyMemberRepository.findFamilyMemberListByNumName("1");

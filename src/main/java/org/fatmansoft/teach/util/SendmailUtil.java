...
public class SendmailUtil {
    ...
    //发件人邮箱
    private static String myEmailAccount = "jam_th@163.com";

    //发件人邮箱密码（授权码）
    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String myEmailPassword = "VLEJIMWYPLBUGTYT";
    ...
    public static void sendEmail(String toEmailAddress, String emailTitle, String emailContent) throws Exception{
        ...
        /**SSL认证，注意腾讯邮箱是基于SSL加密的，所以需要开启才可以使用,网易的163没有使用ssl（应该），不能加这段代码，负责报错**/
...
//        props.put("mail.smtp.ssl.socketFactory", sf);
        ...
        msg.setFrom(new InternetAddress(myEmailAccount,"来自TH", "UTF-8"));
